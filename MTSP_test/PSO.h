...
private:
    //setting argument 
    int Run, Iteration_PSO, Iteration_ACO, nParticle , nAnts ,m;
...
public:
    PSO(){};
    PSO(int nParticle, double w, double c1, double c2, vector<vector<double>> distance_table, int nAnts , int m);
